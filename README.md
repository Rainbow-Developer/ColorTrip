...
| **여정·퀘스트 인증(Journey)** | 여정 생성·관리, 여행명·일정 수정과 삭제, DNA 추천, 퀘스트 인증(GPS·사진·퀴즈), 여정 완료 판정·완료 처리 | `backend/app/journeys/`, `backend/app/quests/`, `backend/app/uploads/`, `frontend/lib/features/travel/` · 스펙 [docs/specs/010-journey/](docs/specs/010-journey/) · [docs/specs/085-journey-management/](docs/specs/085-journey-management/) |
...
| **지역 행사·축제** | 지역 화면의 진행 중·개막 예정 행사 카드와 상세 바텀시트(근처 추천 퀘스트) — TourAPI searchFestival2 실시간 프록시 | `backend/app/places/`, `frontend/lib/features/quests/festival_detail_sheet.dart` · 스펙 [docs/specs/095-festival-info/](docs/specs/095-festival-info/) |
| **관광지 정보 실시간 조회** | 퀘스트 이미지·소개문·운영정보를 TourAPI 실시간 프록시(`GET /places…`)로 표시, 사진 인증 프롬프트에 소개문 포함 | `backend/app/places/`, `frontend/lib/core/widgets/quest_image.dart` · 스펙 [docs/specs/090-realtime-tour-place-info/](docs/specs/090-realtime-tour-place-info/) |
