...
> **이전 구현 기록:** 이 문서는 최초 백엔드 인증 기반의 구현 당시 상태를 기록한다.
> 현재 Flutter SDK 로그인, 단계별 온보딩, secure storage, 즉시 익명화 탈퇴와 검증 결과는
> [035 Kakao 통합 인증](../035-kakao-auth-integration/implementation.md)을 따른다.
