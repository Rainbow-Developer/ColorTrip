...
- **지도 색칠**: 지역 진행도 n에 따라 색이 단계적으로 변한다 — 0 회색(`#CCCCCC`), 1 라이트그린(`#97C459`), 2+ 파랑(`#378ADD`, 2026-07-09부터 진그린에서 변경).
...
| 홈 지도 | 색칠 지도(CustomPainter, 3단계 색상+범례), 스탯, 진행중 여행+DNA 카드, 최근 완료, 공유 진입 | `frontend/lib/features/home/` |
