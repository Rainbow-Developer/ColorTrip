...
/// ([docs/specs/010-journey/description.md] "여정 완료 판정", KAN-104).
library;
...
void main() {
  ...
  test('기간이 지나면 완료 퀘스트가 없어도 완료로 본다', () {
