...
const List<TripDnaQuestion> kTripDnaQuestions = [
  TripDnaQuestion(
    ...
    options: [
      ...
      TripDnaOption(id: 'q1_o4', dnaType: 'active', label: '액티비티와 모험적인 경험'),
  ...
  TripDnaQuestion(
    ...
    options: [
      ...
      TripDnaOption(id: 'q2_o4', dnaType: 'active', label: '활동하는 순간'),
  ...
  TripDnaQuestion(
    ...
    options: [
      ...
      TripDnaOption(id: 'q3_o4', dnaType: 'active', label: '케이블카와 짚라인'),
  ...
  TripDnaQuestion(
    ...
    options: [
      ...
      TripDnaOption(id: 'q4_o4', dnaType: 'active', label: '빽빽하고 알차게'),
